...
export default function Home() {
  ...
  return (
    <>
      ...
      <meta name="description" content="A simple clock app" />
      ...
      <div className="absolute text-md top-1 left-1 text-white font-mono font-black">
        Made by <a href="https://github.com/HaftIsntHere/" target="_blank" className="text-blue-200">Haft</a> • <a target="_blank" href="https://github.com/HaftIsntHere/clock-website">Source code</a>
      </div>
        <div
